...
def main():
    ...
    train_dataset = RFMCDataset(dataset = args.dataset, train=True, samples_per_snr=train_size, num_classes=args.num_classes, snr_gate=args.snr_gate)
    val_dataset = RFMCDataset(dataset = args.dataset, train=False, samples_per_snr=val_size, num_classes=args.num_classes, snr_gate=args.snr_gate)
