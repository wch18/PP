...
class ResNet_N_224x224(ResNet):

    def __init__(self, num_classes=1000,
                 block=Bottleneck, layers=[3, 4, 23, 3]):
        super(ResNet_N_224x224, self).__init__()
        self.inplanes = 64
...
class ResNet_N_32x32(ResNet):

    def __init__(self, num_classes=10,
                 block=BasicBlock, depth=18):
        super(ResNet_N_32x32, self).__init__()
        self.inplanes = 64
        n = int((depth - 2) / 6)
...
class ResNet_S_32x32(ResNet):
    def __init__(self, num_classes=10,
                 block=BasicBlock, depth=18): 
        super(ResNet_S_32x32, self).__init__()
        self.inplanes = 16
        n = int((depth - 2) / 6)
